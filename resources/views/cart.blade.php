...
<head>
    ...
    <title>Panier - Auto Pièces R.M</title>
...
<body>
    <header class="header">
        <nav class="navbar">
            <div class="container">
                <div class="nav-brand">
                    <img src="https://placehold.co/50x50/e60000/ffffff?text=RM" alt="Auto Pièces R.M" class="brand-logo">
                    <span class="brand-text">Auto Pièces R.M</span>
                </div>
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('cart.index') }}" class="nav-link active">Panier</a>
                    </li>
                </ul>
                            ...
                            @foreach($items as $item)
                                <div class="cart-item">
                                    ...
                                    <div class="cart-item-details">
                                        ...
                                        <p class="cart-item-price">{{ number_format($item['price'], 2) }} DH</p>
                                    </div>
                                    ...
                                    <div class="cart-item-subtotal">
                                        <span class="subtotal-amount">{{ number_format($item['price'] * $item['qty'], 2) }} DH</span>
                                    </div>
                        ...
                        <div class="checkout-form-container">
                            ...
                            <form action="{{ route('cart.checkout') }}" method="post" class="checkout-form">
                                ...
                                <button type="submit" class="btn btn-primary btn-full" 
                                    ...
                                    Confirmer la commande ({{ number_format($total, 2) }} DH)
                                </button>
                            </form>
                        </div>
                    </div>
